...
*/
    ...
    O = function(a, b, c) {
        ...
        e = 0; e < d.length; ++e) {
            ...
            if (h = !c || g.forms) a: {
                h = g.domains;
                var k = a;
                if (h && (g.sameHost || k !== t.location.hostname)) for (var l = 0; l < h.length; l++) if (h[l] instanceof RegExp) {
                    if (h[l].test(k)) {
                        h = !0;
                        break a
                    }
    ...
    R = function(a, b) {
        ...
        if (! (b = I)) {
            ...
            for (var c = 0; 256 > c; c++) {
                for (var d = c,
                f = 0; 8 > f; f++) d = d & 1 ? d >>> 1 ^ 3988292384 : d >>> 1;
                b[c] = d
            }
        }
        I = b;
    ...
    var ba = function(a, b, c) {
        ...
        if (r.history && r.history.replaceState) {
            var f = Q("_gl");
            if (f.test(b) || f.test(c)) a = A(a, "path"),
            b = d(b, "?"),
            c = d(c, "#"),
    ...
    function W(a, b) {
        ...
        f = O(b, 2, c);
        b = O(b, 3, c);
        q(d) && (d = S(d), c ? X("_gl", d, a) : Y("_gl", d, a, !1)); ! c && q(f) && (c = S(f), Y("_gl", c, a, !0));
    ...
    }; n("google_tag_data.glBridge.auto",
    function(a, b, c, d) {
        N();
        c = "fragment" === c ? 2 : 1;
        a = {
        ...
        L().decorators.push(a)
    }); n("google_tag_data.glBridge.decorate",
    function(a, b, c) {
        a = S(a);
        return Z("_gl", a, b, !!c)
    }); n("google_tag_data.glBridge.generate", S); n("google_tag_data.glBridge.get",
    function(a, b) {
        var c = ca( !! b);
        b = L();
        b.data || (b.data = {
                    ...
                    if (!ea(Yd.get(b)) && !$d.get(b)) {
                        ...
                        if (c) {
                            ...
                            if (("https:" == a || a == d || ("http:" != a ? 0 : "http:" == d)) && B(ca)) {
                                if (ca = ca.url) a = (a = M.querySelector && M.querySelector("script[nonce]") || null) ? a.nonce || a.getAttribute && a.getAttribute("nonce") || "": "",
                                e ? (e = "", a && Nd.test(a) && (e = ' nonce="' + a + '"'), f.test(ca) && M.write("<script" + e + ' src="' + ca + '">\x3c/script>')) : (e = M.createElement("script"), e.type = "text/javascript", e.async = !0, e.src = ca, a && e.setAttribute("nonce", a), ca = M.getElementsByTagName("script")[0], ca.parentNode.insertBefore(e, ca));
                                $d.set(b, !0)
                            }
                        }
                    }
